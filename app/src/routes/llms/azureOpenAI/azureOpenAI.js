...
const { sendMessageToOpenAI } = require('../../../services/llms/azureOpenAIService/azureOpenAIService');
...
router.post('', authenticateToken, async (req, res) => {
    try {
        ...
        const messageContent = await sendMessageToOpenAI(userId, messages, modelName);
